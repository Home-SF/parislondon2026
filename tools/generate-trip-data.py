...
Can be run from anywhere:
  python3 tools/generate-trip-data.py    # from repo root
  python3 generate-trip-data.py          # from inside tools/
...
def main():
    tools_dir = Path(__file__).resolve().parent   # tools/ (absolute)
